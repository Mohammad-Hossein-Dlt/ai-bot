...
from src.routes.depends.repo_depend import cache_repo_depend, user_repo_depend
...
from src.usecases.bot.text_to_audio.steps.enter_prompt import EnterPrompt
...
async def enter_prompt(
    ...
    conversation: ConversationModel = await save_conversation_usecase.execute(chat_id, messages={"file_id": file_id, "file_name": file_name})
