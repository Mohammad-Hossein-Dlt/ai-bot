...
from src.usecases.bot.text_to_image.steps.choose_ai_platform import ChooseAiPlatform
from src.usecases.bot.text_to_image.steps.choose_model import ChooseModel
from src.usecases.bot.text_to_image.steps.request_summary import RequestSummary
from src.usecases.bot.text_to_image.steps.produce import Produce
from src.usecases.bot.text_to_image.cache import ProduceImageCache
...
async def request_steps(
    ...
    cache_usecase = ProduceImageCache(
        cache_repo,
        user_repo,
        category_repo,
    )
    
    request: TextToImageRequestModel = await cache_usecase.execute(chat_id, callback_data)
